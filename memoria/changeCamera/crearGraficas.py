...
'''
'''
img1b = cv2.imread('appe/mike/townCenter_000028_0109.0.jpg')
img2b = cv2.imread('appe/mike/townCenter_000028_0110.0.jpg')
img3b = cv2.imread('appe/mike/townCenter_000028_0111.0.jpg')
img4b = cv2.imread('appe/mike/townCenter_000028_0112.0.jpg')
img5b = cv2.imread('appe/mike/townCenter_000028_0113.0.jpg')
img6b = cv2.imread('appe/mike/townCenter_000028_0114.0.jpg')
...
img1 = cv2.resize(img1b,(364, 500), interpolation = cv2.INTER_CUBIC)
img2 = cv2.resize(img2b,(364, 500), interpolation = cv2.INTER_CUBIC)
img3 = cv2.resize(img3b,(364, 500), interpolation = cv2.INTER_CUBIC)
img4 = cv2.resize(img4b,(364, 500), interpolation = cv2.INTER_CUBIC)
img5 = cv2.resize(img5b,(364, 500), interpolation = cv2.INTER_CUBIC)
img6 = cv2.resize(img6b,(364, 500), interpolation = cv2.INTER_CUBIC)
...
cv2.imwrite('tomeuPont.png', vis1)
'''
